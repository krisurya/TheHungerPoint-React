...
export class ProductsComponent implements OnInit {
  ...
  constructor(private firestore : FirebaseService, public notify : NotifyService, private storage: AngularFireStorage, 
  ...
  getFile() {
    this.imageUrl = this.storage.ref("test.png").getDownloadURL();
  }
}
